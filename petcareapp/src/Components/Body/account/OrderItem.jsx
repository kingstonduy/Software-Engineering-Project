        ...
        <>
            <div className={cs['table-row']}>
                <div className={cs['product-main-group']}>
                    ...
                    <div className={cs['product-name']}>{item.orderedProductDTOProductName}</div>

                    <div className={cs['product-type']}>{item.orderedProductDTOCategory}</div>
                </div>

                <div className={cs['table-col']}>
                    <div className={cs['product-price']}>${item.orderedProductDTOPrice}</div>

                    <div className={cs['btn-div']}>
                        <button onClick={handleRatting}>RATING</button>
                    </div>
                </div>

                <div className={cs['table-col']}>
                    <div className={cs['product-quantity']}>{item.orderedProductDTOQuantity}</div>
                </div>
