            ...
            <div className={cs['form_Comment']}>
                ...
                <form action="" id="form_changeInformation" className="form">
                    <div className="form-group form-group_fullWidth ">
                        <label htmlFor="fullname-Change" className={cs['form-label']}>
                            Full Name
                        </label>
                        <input
                            type="text"
                            placeholder="Ex: Nguyen Trong Nghia"
                            name="fullName"
                    ...
                    <div className="form-group form-group_fullWidth">
                        <label htmlFor="currentPassword-Change" className={cs['form-label']}>
                            Current password
                        </label>
                        <input
                            type="password"
                    ...
                    <div className="form-group form-group_fullWidth">
                        <label htmlFor="newPassword-Change" className={cs['form-label']}>
                            New password
                        </label>
                        <input
                            type="password"
                    ...
                    <div className="form-group form-group_fullWidth">
                        <label htmlFor="email-Change" className={cs['form-label']}>
                            Email
                        </label>
                        <input
                            type="email"
                    ...
                    <div className={cs['btn_wrap']}>
                        <button onClick={handleCloseBookingForm} className={cs['btn_cancel']}>
                            Cancel
                        </button>
                        <button type="submit" className={cs['btn_addCmt']}>
                            Change
                        </button>
                    </div>
                </form>
